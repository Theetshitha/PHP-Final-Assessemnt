...
<body class="bg-gray-100">
    <nav id="nav" class="bg-blue-500 text-white">
                ...
                <li><a href="../../views/appointments/create.php" class="text-2xl font-bold text-center hover:text-gray-200"> SaveLife Clinic</a></li>
                <li><a href="#" class="hover:text-gray-200">Home</a></li>
                <li><a href="#" class="hover:text-gray-200">About</a></li>
                <li><a href="#" class="hover:text-gray-200">Contact</a></li>
                <li><a href="#" class="hover:text-gray-200">Book Appointment</a></li>
